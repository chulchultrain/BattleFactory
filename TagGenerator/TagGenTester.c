...
char entryFile[100] = FULL_FILTER_ENTRIES_DIR SUB_DIR_DPP ENTRY_FILE1_OF_DATA ;
char entryFile2[100] = FULL_FILTER_ENTRIES_DIR SUB_DIR_DPP ENTRY_FILE2_OF_DATA ;
char entryFile3[100] = FULL_FILTER_ENTRIES_DIR SUB_DIR_DPP ENTRY_FILE3_OF_DATA ;
char entryFile4[100] = FULL_FILTER_ENTRIES_DIR SUB_DIR_DPP ENTRY_FILE4_OF_DATA ;
